...
const Info = () => {
  return (
     <section className="bg-gray-light">
       <div className="">
          <div className="py-20 grid grid-cols-12 gap-12">
          <div className="col-span-7">
            <div className="w-full">
              <div className="w-1/2 py-2 bg-green-primary"></div>
              <div className="pl-10">
                <div className="w-1/2 my-5 font-semibold leading-tight
            ...
            <div className="col-span-5">
              <div className="w-full flex items-end h-full">
                  <div className="w-full">
                    ...
                    <div className="w-full float-right mb-12">
                        <div className="float-right w-9/12 
                        py-2 bg-green-primary"></div>
                    </div>
